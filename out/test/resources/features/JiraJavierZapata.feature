...
#testcase2
    Scenario: Verification of a created task displayed on BackLog page
      ...
      And Insert "Nuevo Task9" input on CreationTaskDialog dialog
      And Click 'Create' button on CreationTaskDialog dialog
      Then Check "Nuevo Task9" in List on BackLog page
...
#      #And set my credentials on 'JiraLoginPage' page
#      #And Click "ProyectoEjemplo" proyecto on HomePage page
#      And Select "Nuevo Task8" task on BackLog page
...
#      #And set my credentials on 'JiraLoginPage' page
#      #And Click "ProyectoEjemplo" proyecto on HomePage page
#      And Select "Nuevo Task7" task on BackLog page
...
#    #And Click "ProyectoEjemplo" proyecto on HomePage page
#    And Select "Nuevo Task7" task on BackLog page
#    Then Click "Mi nuevo comentario" on comment on PanelConfigurationTask page
